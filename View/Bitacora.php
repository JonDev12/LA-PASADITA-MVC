        ...
        <div style="height: 500px; overflow-y: auto;">
            <table border="1">
                <thead>
                    ...
                    <th scope="col" class="text-center encabezado">Usuario</th>
                    <th scope="col" class="text-center encabezado">Afecto</th>
                    <th scope="col" class="text-center encabezado">Columna</th>
                    <th scope="col" class="text-center encabezado">Anterior</th>
                    <th scope="col" class="text-center encabezado">Nuevo</th>
